...
export function Product() {
    ...
    const postProduct = async (e) => {
        ...
        const {product_name, description, price, product_image, created_at, updated_at} = productInfo;
        
        const formData = new FormData();
        formData.append('pro_image', product_image);
                    ...
                    <div className="row">
                        ...
                        <div className="col">
                            ...
                            <form method="POST" encType="multipart/form-data">
                                <div>
                                    <input type="text" name="name" value={productInfo.product_name} className="form-control" placeholder="Enter Product Name"></input>
                                    <textarea name="description" value={productInfo.description} className="form-control" placeholder="Enter Product Description" />
                                    <input type="number" name="price" value={productInfo.price} className="form-control" placeholder="Enter Product Price"></input>
                                    <input type="file" name="pro_image" className="form-control"></input>
