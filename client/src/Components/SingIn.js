                    ...
                    <div className="signup-form mt-5">
                        ...
                        <form className='register-form' onSubmit={postData}>
                            ...
                            <div class="input-group border-bottom mb-3">
                                ...
                                <input type="email" class="form-control" value={user.email} name="email" placeholder="Enter Email" onChange={handleFormData}/>
                            </div>
                            
                            <div class="input-group border-bottom mb-3">
                                <span class="input-group-text bg-input"><i class="zmdi zmdi-lock"></i></span>
                                <input type="password" class="form-control" value={user.password} name="password" placeholder="Enter Password" onChange={handleFormData}/>
                            </div>

                            <div class="input-group mb-3">
                                <input type="submit" class="btn btn-light bg-input form-control" value="Login" />
                            </div>
