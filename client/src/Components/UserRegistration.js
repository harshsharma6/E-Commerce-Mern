                    ...
                    <div className="signup-form">
                        ...
                        <form className='register-form' method='POST' encType='multipart/form-data'>
                            <div class="input-group border-bottom mb-3">
                                <span class="input-group-text bg-input"><i class="zmdi zmdi-upload"></i></span>
                                <input type="file" class="form-control" name="pic"
                                 
                                 onChange={handleImageData}/>
                            </div>
                            <div class="input-group border-bottom mb-3">
                                <span class="input-group-text bg-input"><i class="zmdi zmdi-account"></i></span>
                            ...
                            <div class="input-group border-bottom mb-3">
                                <span class="input-group-text bg-input"><i class="zmdi zmdi-phone-in-talk"></i></span>
                            ...
                            <div class="input-group border-bottom mb-3">
                                <input type="submit" class="btn btn-light bg-input form-control" value="Register" onClick={postData}/>
                            </div>
                        </form>
                    </div>
